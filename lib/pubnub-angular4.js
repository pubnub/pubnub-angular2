...
var PubNubAngular = exports.PubNubAngular = function (_PubNubCommon) {
  _inherits(PubNubAngular, _PubNubCommon);

  function PubNubAngular() {
    _classCallCheck(this, PubNubAngular);

    return _possibleConstructorReturn(this, (PubNubAngular.__proto__ || Object.getPrototypeOf(PubNubAngular)).call(this, _pubnub2.default));
  }

  return PubNubAngular;
}(_pubnubCommon2.default);
//# sourceMappingURL=pubnub-angular4.js.map
